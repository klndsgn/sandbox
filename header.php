                        ...
                        <div class="top-main-menu">
                                <nav class="navbar"  role="navigation">
                                    ...
                                    <div class="navbar-brand">
                                            <img src="<?php echo get_template_directory_uri(); ?>/assets/logo.svg" height="30"> klndsgn<small>apps</small></div>
                                    ...
                                    <div class="collapse pull-right navbar-collapse navbar-ex1-collapse">
                                        <?php
                                        wp_nav_menu(array(
                                            'menu' => '',
